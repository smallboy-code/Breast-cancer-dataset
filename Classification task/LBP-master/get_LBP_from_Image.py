...
if __name__ == '__main__':
    ...
    for type in os.listdir(path):
        ...
        for jpg in os.listdir(type_path):
            ...
            new_path = os.path.join(r'E:\Data\转移性质/LBP/2期/train',type)
            if not os.path.exists(new_path):
                os.makedirs(new_path)
            cv2.imencode('.jpg',basic_array)[1].tofile(os.path.join(new_path,jpg))
            # shutil.copy(image,os.path.join(new_path,jpg))
    print('done')
