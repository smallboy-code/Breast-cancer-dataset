...
def main():
    ...
    parser.add_argument("-i",  "--test_images", help="Path to test image directory", default='./pots\images\store/1')
    parser.add_argument("-g", "--ground_truth_images", help="Path to ground truth image directory", default='./pots\labels\store')
